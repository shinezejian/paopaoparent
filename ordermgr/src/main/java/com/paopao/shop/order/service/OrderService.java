...
import com.paopao.shop.order.dao.OrderMapper;
import com.paopao.shop.order.queue.QueueSender;
...
import com.paopao.shop.store.service.IStoreService;
...
public class OrderService extends BaseService<OrderModel,OrderQueryModel> implements IOrderService{
	...
	@Autowired
	private void setDao(OrderMapper dao){
		this.dao = dao;
		super.setDAO(dao);
	}
